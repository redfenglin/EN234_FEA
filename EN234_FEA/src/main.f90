program en234fea
  ...
  VS_root_folder = 'C:/Users/stell/git/EN234_FEA/EN234_FEA/'   ! This should work with Intel Studio on the remote desktop if you follow the instructions for cloning your EN234FEA fork
...
!   Homework 9 - McCormick model with 1 element
   infil = 'input_files/Abaqus_vumat_final.in'
   outfil = 'Output_files/Abaqus_vumat_final.out'

!    infil = 'input_files/Abaqus_vumat_viscoplastic.in'
!    outfil = 'Output_files/Abaqus_vmat_viscoplastic.out'

!   Homework 10 - Continuum beam element solution to end loaded cantilever beam
!   infil = 'input_files/Abaqus_uel_continuum_beam.in'
!   outfil = 'Output_files/Abaqus_uel_continuum_beam2.out'
